...
export const visualToneStyles: Record<VisualTone, VisualToneStyle> = {
  neutral: {
    card: "border-slate-200 bg-slate-100/80 shadow-slate-200/70",
    softCard: "border-slate-200 bg-slate-100/80 shadow-slate-200/70",
    header: "border-slate-200 bg-slate-50",
    icon: "bg-white/80 text-slate-600",
  ...
  brand: {
    card: "border-[#0F4C5C]/25 bg-[#0F4C5C]/[0.08] shadow-[#0F4C5C]/10",
    softCard: "border-[#0F4C5C]/25 bg-[#0F4C5C]/[0.08] shadow-[#0F4C5C]/10",
    header: "border-slate-200 bg-slate-50",
    icon: "bg-white/80 text-[#0F4C5C]",
  ...
  info: {
    card: "border-sky-200 bg-sky-50/90 shadow-sky-100/70",
    softCard: "border-sky-200 bg-sky-50/90 shadow-sky-100/70",
    header: "border-slate-200 bg-slate-50",
    icon: "bg-white/85 text-sky-700",
  ...
  success: {
    card: "border-emerald-200 bg-emerald-50/90 shadow-emerald-100/70",
    softCard: "border-emerald-200 bg-emerald-50/90 shadow-emerald-100/70",
    header: "border-slate-200 bg-slate-50",
  ...
  warning: {
    card: "border-amber-200 bg-amber-50/90 shadow-amber-100/70",
    softCard: "border-amber-200 bg-amber-50/90 shadow-amber-100/70",
    header: "border-slate-200 bg-slate-50",
  ...
  danger: {
    card: "border-red-200 bg-red-50/90 shadow-red-100/70",
    softCard: "border-red-200 bg-red-50/90 shadow-red-100/70",
    header: "border-slate-200 bg-slate-50",
    icon: "bg-white/85 text-red-700",
